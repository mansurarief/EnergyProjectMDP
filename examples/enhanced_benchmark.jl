...
# Include our new enhanced components
include("../src/enhanced_policies.jl")
include("../src/enhanced_reward.jl")
include("../src/tuned_mdp.jl")

# Update module exports
import EnergyProjectMDP: PriorityBasedPolicy, OptimizationGreedyPolicy, SmartSequentialPolicy, NearOptimalPolicy
...
# Create tuned MDP
mdp = create_comparison_mdp()  # Use smaller MDP for faster testing
...
println("\n💡 Key Findings:")
println("1. Enhanced policies significantly outperform basic random baseline")
println("2. Multi-objective approaches balance competing goals effectively")
println("3. Equity metrics reveal disparities between income groups")
println("4. Parameter tuning improves overall system performance")
